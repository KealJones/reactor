...
enableTestMode() {
  ...
  reactJsScript.attributes.addAll({
    'src': 'packages/reactor/js/react.development.js',
  });
  reactDomJsScript.attributes.addAll({
    'src': 'packages/reactor/js/react-dom.development.js',
  });
