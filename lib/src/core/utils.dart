...
class ReactorUtils {
  ...
  static call(dynamic object, String methodName, [List<dynamic> args = const []]) =>
      js_util.callMethod(object, methodName, args);

  static define(dynamic object, String property, dynamic value) =>
      JsObject.defineProperty(object, property, value is DefinePropertyValue ? value : DefinePropertyValue(value: value));
